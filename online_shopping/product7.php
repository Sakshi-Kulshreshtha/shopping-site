		...
		<div class="container">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Oats</li>
				</ol>
			</div>
			<div class="row">
			<div class="col-md-8">
				<h3 class="pp-title">Saffola Masala Oats</h3>
				<img src="images/products/oats-buy.jpg" class="img-responsive">
				<h4 class="pp-desc-head">Description</h4>
				<div class="pp-desc-detail">
					<p>It comes in a variety of flavours</p>
					<ul>
						<li>It's rich in protein and good for weight loss</li>
