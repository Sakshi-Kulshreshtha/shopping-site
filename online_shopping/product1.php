		...
		<div class="container">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li><a href="#">Men Western Wear</a></li>
					<li class="active">Jeans</li>
				</ol>
			</div>
			<div class="row">
			<div class="col-md-8">
				<h3 class="pp-title">Roadster Jeans</h3>
				<img src="images/products/jeans-buy.jfif" class="img-responsive">
				...
				<div class="pp-desc-detail">
					...
					<ul>
						<li>It's Beautiful and stretchable</li>
